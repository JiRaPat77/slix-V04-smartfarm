...
//  { 3,   ST_WIND,          1,        "01"  },  // Wind Speed+Dir RK120
//  { 4,   ST_AIR_TEMP,      1,        "01"  },  // Air Temp+Humidity RS-WS
//  { 5,   ST_SOLAR,         1,        "01"  },  // Solar Radiation RK200
//  { 6,   ST_RAINFALL,      50,       "01"  },  // Rain Tip Counter RK400
