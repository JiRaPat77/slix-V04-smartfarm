...
class MCP23017:
    ...
    def __init__(self, bus=3, address=0x23):
...
if __name__ == "__main__":
    try:
        ...
        print("Testing MCP23017 at 0x23")
        mcp = MCP23017(bus=3, address=0x23)
        
        # Configure Port 
        mcp.set_pin_mode('B', 0, 0) # sensor_en9
        mcp.set_pin_mode('B', 1, 0) # sensor_en10
        mcp.set_pin_mode('B', 2, 0) # sensor_en11
        mcp.set_pin_mode('B', 3, 0) # sensor_en12
        
        mcp.set_pin_mode('B', 4, 1) # over_current9
        mcp.set_pin_mode('B', 5, 1) # over_current10
        mcp.set_pin_mode('B', 6, 1) # over_current11
        mcp.set_pin_mode('B', 7, 1) # over_current12
        
        mcp.set_pin_mode('A', 7, 1) # over_current16
        mcp.set_pin_mode('A', 6, 1) # over_current15
        mcp.set_pin_mode('A', 5, 1) # over_current14
        mcp.set_pin_mode('A', 4, 1) # over_current13
        
        mcp.set_pin_mode('A', 3, 0) # sensor_en16
        mcp.set_pin_mode('A', 2, 0) # sensor_en15
        mcp.set_pin_mode('A', 1, 0) # sensor_en14
        mcp.set_pin_mode('A', 0, 0) # sensor_en13
        ...
        while True:
            ...
            mcp.write_pin('B', 1, 1)
            print("On Output")
            print("Over Current9:",mcp.read_pin('B', 5))
            print("Over Current16:",mcp.read_pin('A', 7))
            time.sleep(1)
